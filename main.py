...
if __name__ == "__main__":
    model_path = "C:/Users/MSwati/Desktop/crowd-counting-using-tensorflow-master/data/utils/my_model.pb"
    peop_counter = People_Counter(path=model_path)
    threshold = 0.4
    no=1
    for n in pbar(glob.glob("C:/Users/MSwati/Desktop/crowd-counting-using-tensorflow-master/data/images/test/*.jpg")):
        count=0
        img = cv2.imread(n)
        ...
        cv2.imwrite("C:/Users/MSwati/Desktop/crowd-counting-using-tensorflow-master/results/result%04i.jpg" %no, img)
        no+=1
